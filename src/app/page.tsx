...
export default function HomePage() {
  return (
    <main>
      ...
      <p className="mx-auto max-w-7xl px-4 pt-5 text-sm leading-6 text-white/65">Steal An Egg Roblox guide for stealing eggs, hatching pets, building passive cash income, unlocking biomes, and protecting your base.</p>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 lg:grid-cols-2">
          ...
          <div>
            <SectionHeader
              ...
              copy="Open focused pages for pets, biome egg pools, mutation multipliers, machine unlocks, codes, and changing update records."
            />
            <div className="mt-6 grid gap-3">
              {wikiCards.map((item) => (
