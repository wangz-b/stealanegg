    ...
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        <article className="content-card">
          ...
          <p className="mt-3 text-sm leading-6 text-white/66">Enter your current Cash target, pet income, offline time, and upgrade price before treating an estimate as useful.</p>
        </article>
        <article className="content-card">
