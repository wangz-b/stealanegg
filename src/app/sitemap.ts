...
const routes: Array<{
  ...
  { path: "/pets", changeFrequency: "weekly", priority: 0.78 },
  { path: "/eggs", changeFrequency: "weekly", priority: 0.78 },
  { path: "/pets/crane", changeFrequency: "weekly", priority: 0.78 },
  { path: "/biomes/cherry-blossom", changeFrequency: "weekly", priority: 0.78 },
  { path: "/mutations", changeFrequency: "weekly", priority: 0.70 },
  { path: "/guides/sakura-incubator", changeFrequency: "weekly", priority: 0.78 },
  { path: "/biomes/titan-temple", changeFrequency: "daily", priority: 0.70 },
  { path: "/biomes", changeFrequency: "weekly", priority: 0.70 },
  { path: "/guides/egg-spawn-times", changeFrequency: "daily", priority: 0.78 },
  { path: "/guides/hidden-secrets", changeFrequency: "weekly", priority: 0.78 },
  { path: "/updates/game-status", changeFrequency: "daily", priority: 0.78 },
];
