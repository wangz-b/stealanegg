    ...
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-8 grid gap-4 lg:grid-cols-3">
        <article className="content-card">
          <span className="mini-label">Reported values · checked date</span>
        ...
        <article className="content-card">
          <span className="mini-label">Reference notes</span>
      ...
      <section className="mt-10 grid gap-4 lg:grid-cols-3">
        ...
        <article className="content-card">
          ...
          <p className="mt-2 text-sm leading-6 text-white/66">Compare pets by repeatable cash income, biome access, hatch risk, and machine utility.</p>
        </article>
        <article className="content-card">
