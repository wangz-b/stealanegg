...
export const metadata: Metadata = {
  ...
  openGraph: { title: `${siteConfig.gameName} Trello, Discord & Wiki Status`, description: `Check which ${siteConfig.gameName} Roblox, Trello, Discord and wiki links are official, disputed or community-run.`, url: `${siteConfig.domain}/trello`, images: ["/opengraph-image"] },
  twitter: { card: "summary_large_image", title: `${siteConfig.gameName} Trello, Discord & Wiki Status`, description: `Check official, disputed and community ${siteConfig.gameName} links.`, images: ["/opengraph-image"] }
};
