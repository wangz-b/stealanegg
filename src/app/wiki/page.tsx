...
const coreSystems = [
  {
    ...
    body: "Start here for pet income, biome egg pools, code rewards, Crane, and machine unlocks before spending time."
  },
  {
    title: "Maps and systems",
    body: "Use this path for biome gates, shared-center egg runs, base defense, events, machines, and progression rules."
  },
  {
    title: "Builds and entities",
    body: "Use this path for pets, rarity, size, mutations, cash values, ranking questions, and hatch choices."
  }
];
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        eyebrow="Wiki hub"
        title={`${siteConfig.gameName} Wiki`}
        description="This Steal An Egg Wiki Guide connects pets, eggs, biomes, mutations and machines to the next action in Roblox."
      />
      <AdsterraArticleTop />
      ...
      <section className="mt-10 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <article className="content-card">
          ...
          <div className="mt-6 grid gap-3 text-sm leading-6 text-white/68">
            <p>
              The Steal An Egg Wiki covers the egg-stealing loop, passive-income pets, biome pools, mutation multipliers, Crane and the Sakura Incubator.
            </p>
            <p>
