...
export const siteConfig: SiteConfig = {
  ...
  freshnessLabel: "pet income, egg pools, mutations, codes and update checks",
  keywords: [
    `${gameConfig.name}`,
  ...
  navGroups: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: "Pet Roles", href: "/wiki/builds-and-entities", description: "Pet income roles, rarity records, mutations, and progression targets." },
        { label: "Pets", href: "/pets", description: "Compare documented pets, biomes, rarities, and base income." },
        { label: "Eggs", href: "/eggs", description: "Browse egg pools by biome without guessed hatch odds." },
        { label: "Mutations", href: "/mutations", description: "Compare editable mutation multiplier records." }
      ]
    },
    {
      label: "Tools",
      ...
      items: [
        ...
        { label: "Squad Planner", href: "/squad-planner", description: "Team, unit, pet, or build-combo planning." },
        { label: "Resource Calculator", href: "/resource-calculator", description: "Currency, rewards, upgrades, and grind estimates." },
...
export const activeCodes: GameCode[] = [
  {
    ...
    reward: `No working ${gameConfig.name} code was verified on the official Roblox page or a creator-controlled announcement during the September 8, 2026 check.`,
    status: "No active codes collected",
    addedDate: "Checked September 8, 2026"
  }
];
...
export const tierPreview: TierPreviewItem[] = [
  {
    ...
    tier: "S",
    role: "Starter path",
    reason: "A documented $1.8K/s Legendary Forest target that gives early players a clear income goal without reaching a later biome.",
    confidence: "Current pick",
    bestFor: ["Forest progression", "early income"],
    sourceNote: "Community egg index checked September 8, 2026.",
    teamNote: "Income ranking excludes size and mutation bonuses."
  },
  {
    name: "Crane",
    tier: "A",
    role: "Utility",
    reason: "Its $4K/s base income is modest later on, but checked guides connect Crane to unlocking the Sakura Incubator.",
    confidence: "Current pick",
    bestFor: ["Sakura Incubator", "Cherry Blossom"],
    sourceNote: "Major guide checked September 8, 2026; consumption behavior remains disputed.",
    teamNote: "Read the current machine prompt before using the pet."
  },
  {
    name: "Unicorn",
    tier: "A",
    role: "Late game",
    reason: "The selected community table records $1B/s base income, the largest resolved figure in the current sample.",
    confidence: "Current pick",
    bestFor: ["Cosmic progression", "base income"],
    sourceNote: "Community value checked September 8, 2026; not claimed as a permanent best-in-game pet.",
    teamNote: "Compare the live value because patches, size and mutations can change results."
  }
];
...
export const wikiCards: LinkCard[] = [
  {
    ...
    eyebrow: "Wiki",
    description: "Compare pets, egg pools, base income, mutations, and machine unlocks."
  },
  {
    title: "Maps and systems",
    href: "/wiki/maps-and-systems",
    eyebrow: "Wiki",
    description: "Browse biomes, Speed gates, egg routes, machines, events, and base systems."
  },
  {
    title: "Builds and entities",
    href: "/wiki/builds-and-entities",
    eyebrow: "Wiki",
    description: "Compare pet roles, rarity records, income targets, and progression choices."
  }
];
...
export const guideTopicPages: TopicPage[] = [
  {
    ...
    description: "A first-session guide for learning the core loop, using starter rewards, avoiding early mistakes, and choosing the next page before spending rare resources.",
    ...
    quickAnswer: "Start by learning the core game loop, redeeming starter rewards, and saving rare resources until the first upgrade or build choice is clear.",
    actionSteps: [
      {
        title: "1. Learn the loop",
        body: "Play enough to understand how players earn rewards and what makes the next run better."
      },
      {
        title: "2. Claim available rewards",
        body: "Use the codes page and in-game reward menus before a long first session."
      },
      {
        title: "3. Choose the first upgrade by payoff",
        body: "Pick the option that improves the next few runs, not the one that only sounds rare."
      },
      {
        title: "4. Move to progression",
        body: "Once the first loop is clear, use the progression guide for upgrades, farming, and reset timing."
      }
    ],
    stuckHelp: [
      {
